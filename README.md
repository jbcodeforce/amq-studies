...
2. `git clone https://github.com/jbcodeforce/$1.git` _(or your forked repository if you plan to edit)_
3. `cd $1`
4. `mkdocs serve`
...
2. Ensure that you have the latest commits to the `gh-pages` branch, so you can get others' updates.
	...
	git checkout master
	```
3. Run `mkdocs gh-deploy` from the root openshift-$1 directory.
